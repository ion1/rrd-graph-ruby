...
require 'rrd/graph/expr'
require 'rrd/logger'

module RRD
  class Graph
    COLORS = ['000066', 'ff9900', '007700', '9900ff', '666666', '000000']
    ...
    def run
      ...
      begin
        Logger.instance.info "Generating #{@filename}"
        Logger.instance.debug "Parameters:\n#{@params.pretty_inspect}"

        unless system *params
          raise RuntimeError, "rrdtool failed"
        end
